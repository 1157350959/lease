...
public class  LeaseAgreementController {
    ...
    public Result<List<AgreementItemVo>> listItem() {
        //"username" here is saving user's phone number, using the phone number as their initial username
    ...
    public Result<AgreementDetailVo> getDetailById(@RequestParam Long id) {
        AgreementDetailVo agreemetnDetailVo = leaseAgreementService.getDetailById(id);
        return Result.ok(agreemetnDetailVo);
    }
    ...
    public Result updateStatusById(@RequestParam Long id, @RequestParam LeaseStatus leaseStatus) {
        ...
        leaseAgreementLambdaQueryWrapper.eq(LeaseAgreement::getStatus, leaseStatus);
